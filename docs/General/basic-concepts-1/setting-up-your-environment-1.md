...
> 🚧 
> 
> Please make sure, that the API-user has the role  **I_BUSINESSFACADE** and that the option "Dialog user" is not checked.
...
> 🚧 
> 
> If you are using "Try it!" via [REST](ref:),  remember to use  
> <strong> user@client</strong> as username in the "AUTHORIZATION" field and switch to "Basic"
...
(the header is **_X-XNSG_WEB_TOKEN_**).
