...
next:
  description: ''
---
## Risk Assessment integration into Export Control checks

Export Control checks can be integrated into a partner system in any way described in [API usage scenarios for Export Controls](doc:api-usage-scenarios). Here, we focus on the peculiarities of Risk Assessment integration into Export Controls API.
